...
export function APISelectionDialog({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-white border-0 text-foreground p-0 gap-0 shadow-xl rounded-xl overflow-hidden">
        ...
        <div className="flex flex-col gap-3 px-4 py-3">
          {/* API Oficial - Com tag de recomendado */}
          <div 
            className={`relative bg-muted/50 rounded-lg p-4 cursor-not-allowed opacity-70`}
          >
            <div className="flex gap-3">
              <div className="h-12 w-12 bg-blue-600 rounded-md flex items-center justify-center text-white">
            ...
            <div className="absolute top-2 right-2 bg-green-600 text-white text-xs px-2 py-0.5 rounded-full shadow-sm">
              Recomendado
            </div>
          </div>
          ...
          {/* Conexão WaApi */}
          <div 
            className={`bg-white border border-border rounded-lg p-4 cursor-pointer hover:bg-muted/20 transition-colors`}
            onClick={() => handleSelectOption('waapi')}
          >
            <div className="flex gap-3">
              <div className="h-12 w-12 bg-purple-600 rounded-md flex items-center justify-center text-white shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
              ...
              <div>
                <h3 className="font-medium text-base">Conexão WaApi</h3>
                <p className="text-sm text-muted-foreground">
                  API simples e performática para interagir com o WhatsApp
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Conexão não-oficial */}
          <div 
            className={`bg-white border border-border rounded-lg p-4 cursor-pointer hover:bg-muted/20 transition-colors shadow-sm`}
          ...
          >
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Conecte o Selfflux escaneando o QRCODE de conexão diretamente no seu WhatsApp
                </p>
              </div>
            </div>
          </div>
